...
export default function MainScreen() {
  ...
  useEffect(() => {
    const keyboardShowListener: EmitterSubscription = Keyboard.addListener("keyboardDidShow", () => {
    ...
    const keyboardHideListener: EmitterSubscription = Keyboard.addListener("keyboardDidHide", () => {
      Animated.timing(infoOpacity, {
        toValue: 1,
        duration: 300,
        useNativeDriver: true
